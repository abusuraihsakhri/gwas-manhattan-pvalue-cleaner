"""
Automated Pytest for gwas-manhattan-pvalue-cleaner Enrichment Modules.
"""
import sys
...
from enrichment import (
    ManhattanPlotGeneratorEngine,
    QqPlotGeneratorEngine,
    LdScoreRegressionIntegrationEngine,
    GeneAnnotationOverlayEngine,
    MultitraitComparisonEngine,
    RestApiServerEngine,
    GwasmanhattanpvaluecleanerEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = GwasmanhattanpvaluecleanerEnrichmentSuite()
