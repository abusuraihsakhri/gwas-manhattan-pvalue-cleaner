"""
FastAPI REST API Server for Gwas Manhattan Pvalue Cleaner.
"""
...
app = FastAPI(
    title="Gwas Manhattan Pvalue Cleaner API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "gwas-manhattan-pvalue-cleaner", "domain": "Privacy-Preserving Federated Healthcare & FHE", "standard": "HIPAA Safe Harbor §164.514 / Google SecAgg Standards", "version": "3.0.0-ENTERPRISE"}
